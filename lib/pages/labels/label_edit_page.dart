...
class _LabelEditPageState extends State<LabelEditPage> {
  ...
  // コントローラーを管理
  List<TextEditingController> _leftLabelControllers = [];
  List<TextEditingController> _rightLabelControllers = [];
  ...
  void dispose() {
    // コントローラーを破棄
    _leftLabelControllers.forEach((controller) => controller.dispose());
    _rightLabelControllers.forEach((controller) => controller.dispose());
