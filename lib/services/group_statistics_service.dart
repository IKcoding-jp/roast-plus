...
class GroupStatisticsService {
  ...
  Future<int> getTodayRoastRecordsCount(String groupId) async {
    try {
      ...
      print('Error getting today roast records count: $e');
      return 0;
    }
  }
  ...
  Future<int> getThisWeekActivityCount(String groupId) async {
    try {
      ...
      final querySnapshot = await _firestore
          ...
          .doc(groupId)
          .collection('roast_records')
          .where('timestamp', isGreaterThanOrEqualTo: startOfWeekDay.toIso8601String())
          .get();

      return querySnapshot.docs.length;
    } catch (e) {
      print('Error getting this week activity count: $e');
      return 0;
    }
  }
  ...
  Future<double> getTotalRoastTime(String groupId) async {
    try {
      ...
      print('Error getting total roast time: $e');
      return 0.0;
    }
  }
  ...
  Future<Map<String, dynamic>> getGroupStatistics(String groupId) async {
    try {
      ...
      print('Error getting group statistics: $e');
      return {
        'todayRoastCount': 0,
